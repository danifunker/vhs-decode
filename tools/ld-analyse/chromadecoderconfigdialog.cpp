                                                 ...
                                                 const OutputWriter::Configuration &_outputConfiguration)
{
    ...
    ntscConfiguration.adaptThresholdMultiplier = qBound(0.1, ntscConfiguration.adaptThresholdMultiplier, 2.0);
...
void ChromaDecoderConfigDialog::updateDialog()
{
    ...
    ui->adaptThresholdHorizontalSlider->setValue(static_cast<qint32>(ntscConfiguration.adaptThresholdMultiplier * 100));
